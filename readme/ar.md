...
يقوم Replexica AI بأتمتة توطين البرمجيات بشكل كامل.

ينتج ترجمات أصيلة فورياً، مما يلغي العمل اليدوي والأعباء الإدارية. يفهم محرك Replexica للتوطين سياق المنتج، مما يؤدي إلى إنشاء ترجمات مثالية يتوقعها المتحدثون الأصليون في أكثر من 60 لغة. نتيجة لذلك، تقوم الفرق بالتوطين بسرعة أكبر 100 مرة، مع جودة متطورة، وإيصال الميزات إلى المزيد من العملاء الدافعين حول العالم.
...
يحتوي هذا المستودع أيضاً على تجربتنا الجديدة: مترجم توطين JS/React.

يتيح لفرق التطوير توطين الواجهة الأمامية **بدون استخراج النصوص إلى ملفات الترجمة**. يمكن للفرق الحصول على واجهة أمامية متعددة اللغات بسطر برمجي واحد فقط. يعمل في وقت البناء، ويستخدم معالجة شجرة التركيب المجردة (AST) وتوليد الكود.

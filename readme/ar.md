...
يتيح لفرق التطوير توطين الواجهة الأمامية **بدون استخراج النصوص إلى ملفات الترجمة**. يمكن للفرق الحصول على واجهة أمامية متعددة اللغات بسطر برمجي واحد فقط. يعمل في وقت البناء، ويستخدم معالجة شجرة الصيغة المجردة (AST) وتوليد الكود.

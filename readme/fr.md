...
Il permet aux équipes de développement de localiser leur frontend **sans extraire les chaînes dans des fichiers de traduction**. Les équipes peuvent obtenir un frontend multilingue avec une seule ligne de code. Il fonctionne au moment de la compilation, utilise la manipulation d'arbre syntaxique abstrait (AST) et la génération de code.
...
- 📈 **Scalable** : Pour les startups en croissance et les équipes enterprise

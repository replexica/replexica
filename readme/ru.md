...
Lingo.dev автоматизирует локализацию программного обеспечения от начала до конца.
...
Этот action запускает `lingo.dev i18n` при каждом пуше, автоматически поддерживая актуальность ваших переводов.

Для режима pull request и других опций конфигурации посетите нашу [документацию по GitHub Action](https://docs.lingo.dev/setup/gha).

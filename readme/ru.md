...
<p align="center">
  <strong>⚡️ Современная локализация с использованием искусственного интеллекта для веб и мобильных устройств, прямо в CI/CD.</strong>
</p>
...
Не нашли свой язык? Добавьте новый код языка в [`i18n.json`](./i18n.json) файл и откройте pull request.
